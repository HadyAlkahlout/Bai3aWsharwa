...
class HomeFullSellerAdapter(var onClick: SellerClick) :
    RecyclerView.Adapter<HomeFullSellerAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view: View =
            LayoutInflater.from(parent.context).inflate(R.layout.full_broker_item, parent, false)
